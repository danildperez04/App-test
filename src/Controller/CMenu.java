...
public class CMenu {
    ...
    private void A1MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        englishTest.addQuestion(new Question("Cual es la pregunta2", new String[]{"Nada2", "Si hay2", "no2", "Ya2"}, "/Imagenes/confuso.png", 1, "2", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta3", new String[]{"Nada3", "Si hay3", "no3", "Ya3"}, "/Imagenes/unicornio.png", 2, "3", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta4", new String[]{"Nada4", "Si hay4", "no4", "Ya4"}, "/Imagenes/idea.png", 3, "4", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta5", new String[]{"Nada5", "Si hay5", "no5", "Ya5"}, "/Imagenes/pensando.png", 4, "5", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta6", new String[]{"Nada6", "Si hay6", "no6", "Ya6"}, "/Imagenes/idea (1).png", 5, "6", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta7", new String[]{"Nada7", "Si hay7", "no7", "Ya7"}, "/Imagenes/pensar.png", 6, "7", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta8", new String[]{"Nada8", "Si hay8", "no8", "Ya8"}, "/Imagenes/profesor.png", 7, "8", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta9", new String[]{"Nada9", "Si hay9", "no9", "Ya9"}, "/Imagenes/reina.png", 8, "9", "https://www.britishcouncil.es/ingles/niveles/a1"));
        englishTest.addQuestion(new Question("Cual es la pregunta10", new String[]{"Nada10", "Si hay10", "no10", "Ya10"}, "/Imagenes/reino-unido.png", 9, "10", "https://www.britishcouncil.es/ingles/niveles/a1"));
    ...
    private void A2MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        Question model = new Question();
        Test englishTest = new Test();
        englishTest.addQuestion(new Question("A2", new String[]{"Nada1", "correcta", "no1", "Ya1"}, "/Imagenes/pregunta (1).png", 0, "correcta", "https://www.britishcouncil.es/ingles/niveles/a1"));
